...
const Footer = () => {
    return (
       <div className='bg-sky-500'>
         <footer className="px-4 divide-y text-white  max-w-6xl mx-auto">
        <div className=" flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                
                    <span className="self-center text-3xl font-bold">RelateHub</span>
                </a>
            </div>
        ...
        <div className="py-6 text-center text-white   ">© Nutron LTD Co. All rights reserved.</div>
    </footer>
       </div>
    );
};
